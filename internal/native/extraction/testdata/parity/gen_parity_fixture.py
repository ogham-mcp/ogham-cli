...
Run:
    cd /Users/kevinburns/Developer/web-projects/openbrain-sharedmemory
    .venv/bin/python3 \\
...
CORPUS: list[dict] = [
    ...
    {"content": "FileNotFoundError on /Users/kevin/.ogham/config.toml during the first run -- init wizard hadn't been run yet.", "tags": ["type:bug"]},
    ...
    {"content": "Added testdata/cache/fixture.db as a cross-stack round-trip fixture for /Users/kevin/foo/bar.txt path extraction.", "tags": []},
    ...
    {"content": "FreiburgLab is the internal name for the research preview; rename before public launch.", "tags": []},

    # --- Person names ---
    {"content": "Kevin Burns shipped the Voyage + Mistral absorption in commit bfd3378 on 2026-04-21.", "tags": []},
    {"content": "Iain Bennett tested the v0.4 release against his self-hosted stack; found no regressions.", "tags": []},
    {"content": "Nate Jones linked the Ogham demo video from his YouTube channel in the comments section.", "tags": []},
    {"content": "Cemre Topcu is interested in picking up the Agent Zero importer as a contributor task.", "tags": []},
    {"content": "Tobias Schmidt mentioned Freiberufler status at the last VDA call, not Gewerbe.", "tags": []},
    {"content": "Sarah Chen asked whether Ogham supports Clerk Organizations for team shared memory -- it's on the v0.7 roadmap.", "tags": []},
    ...
    {"content": "Let's talk again tomorrow about the Rackspace pitch deck.", "tags": []},
    ...
    {"content": "Mid-April 2026 we flip the ogham-cli repo public assuming Section 12.1 clears.", "tags": []},
    {"content": "Meeting on 2026-04-25 at 10:00 CET with the DACH senior management team.", "tags": []},
    ...
    {"content": "Lisa's wedding on 2026-06-15 is a fun event; we're blocking the week before for prep.", "tags": []},
    {"content": "My favorite editor is still Neovim; wrote the init.lua at /Users/kevin/.config/nvim/init.lua.", "tags": []},
    {"content": "3 tanks of compressed CO2 arrived at the lab on 2026-04-20.", "tags": []},
    {"content": "My sister Anna Schmidt sent me a ClerkOrganization invite yesterday.", "tags": []},
    ...
    {"content": "Anna Lindgren merged PR #142 on 2026-04-21 fixing the GeminiEmbedder normalization bug.", "tags": ["type:merge"]},
    {"content": "Built an EmbeddingCacheBench to compare Gemini vs Voyage at /Users/kevin/bench/cache.go -- Voyage is 40% faster cold.", "tags": []},
    ...
    {"content": "Elizabeth Monroe-Parker (two-word hyphenated last name) reviewed the BEAM harness design.", "tags": []},
    {"content": "McDonald Kim is a common misreading of two distinct people in the Rackspace EMEA org.", "tags": []},
